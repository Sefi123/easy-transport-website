...
import { getUserSmTrucks, getUserLgTrucks } from "../../redux/vehicles/vehicles.actions";
    ...
    <div className="ftco-section">
      <div className="container-fluid ">
       ...
       {!show? <div className="col-md-6 col-lg-4">
            <Card className={`effectCard bg-white container-fluid`}>
              ...
              <CardBody>
                <div className={`d-flex justify-content-between mb-3`}>
                  ...
                  <p className="mb-0 text-muted text-capitalize">{truckData.name}</p>
                </div>
                <div className="topBorder mb-3"></div>
                <div className="d-flex justify-content-between mb-3">
                  <h6 className="mb-0">Color</h6>
                  <p className="mb-0 text-muted text-capitalize">{truckData.color}</p>
                </div>
                <div className="topBorder mb-3"></div>
                <div className="d-flex justify-content-between mb-3">
                ...
                <div className="d-flex justify-content-between mb-3">
                  ...
                  <p className="mb-0 text-muted">{truckData.luggageCapacity} KG</p>
                </div>
                <div className="topBorder mb-3"></div>
                <div className="d-flex justify-content-between mb-3">
                  <h6 className="mb-0">Average Charges</h6>
                  <p className="mb-0 text-muted">PKR {truckData.perDayPrice}</p>
                </div>
          ...
          </div> : <div className="col-md-6"> <VehicleBooking vehicleDetails={truckData}/> </div>}
