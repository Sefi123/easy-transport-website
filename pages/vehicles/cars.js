  ...
  return (
    <section className="ftco-section">
      <div className="container-fluid customFluid">
        ...
        ) : (filterData.length<=0?(<div className="noData"><h6 className="GradientBorder">No Vehicles Available</h6></div>)
        :(
        <> <div className="row">
                ...
                <Card className="effectCard">
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <p className="mb-0 text-capitalize text-danger">{car.name}</p>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="mb-0">Color</h6>
                      <p className="text-danger mb-0 text-capitalize">{car.color}</p>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="mb-0">Model Year</h6>
                      <p className="text-danger mb-0">{car.modelYear}</p>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="mb-0">Transmission</h6>
                      <p className="text-danger mb-0">{car.transmission}</p>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="mb-0">City</h6>
                      <p className="text-danger mb-0">{car.fromCity}</p>
                    </div>
                    <div className="topBorder mb-3"></div>
                    <div className="d-flex justify-content-between">
                      <h6 className="mb-0">Per Day Charges</h6>
                      <h6 className="text-danger mb-0">PKR {car.perDayPrice}</h6>
                    </div>
                  </div>
                </Card>
              </div>
